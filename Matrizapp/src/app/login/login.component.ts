...
export class LoginComponent implements OnInit {
  ...
  deafultValues() {
    ...
    Swal2.fire({
      icon: 'info',
      html: 'Matriz de riesgos, Copyright  . <br /> <b>Summa consulting.</b><br /> Version Aplicativo WEB 4.5.0 <br />Fecha de compilación: 2023-09-04<br />',
  ...
  perfilesUsuario(){
    let PerfilRkj = localStorage.getItem('PerfilRkj')
