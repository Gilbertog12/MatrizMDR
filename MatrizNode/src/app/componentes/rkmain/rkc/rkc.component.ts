...
public Razon : string
  ...
  acciones = [
    {value: 'Agregar' , icon : 'add_task', disable:false},
  ];
  acciones2 = [
    {value: 'Agregar' , icon : 'add_task', disable:false},
    {value: 'Copiar' , icon : 'copy_all', disable:false},
    
  ];
  acciones3 = [
    {value: 'Agregar' , icon : 'add_task', disable:false},
    {value: 'Pegar' , icon : 'content_paste_go', disable:false},
  ];
 ...
 console.log(data)
  ...
  async guardarCheckListEllipse() {
    ...
    let conf = this.confirm.open( ChecklistComponent, {
      hasBackdrop: true,
      height: 'auto',
      width: 'auto',
      data: {
      ...
      cargarPestañaCheck(){
        ...
        if(this.actividadModel.actividadStatusId !=='001' || this.actividadModel.actividadStatusId !=='002' || this.actividadModel.actividadStatusId !=='008'){
          ...
          if(this.actividadModel.CanAdd === 'false' ){
            ...
            this.acciones[0].disable = true
            this.acciones2[0].disable = true
            this.acciones3[0].disable = true
            this.acciones3[1].disable = true
          }
  ...
  console.log(this.paste.length)
    ...
    async RestaurarItem() {
      ...
      if (accept) {
        ...
        _atts.push({ name: "checkNo", value: this.paste });
